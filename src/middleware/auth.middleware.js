 ...
 * Validates httpOnly JWT cookie, checks user active status & soft-deletion, and attaches req.user.
 */
export async function authenticateToken(req, res, next) {
  try {
    ...
    // Lookup active user from database, joining role & checking soft deletion
